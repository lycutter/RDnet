...
parser.add_argument('--dataDir', default='D:/pythonWorkplace/Dataset/DIV2K', help='dataset directory')
...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        for batch, (im_lr, im_hr) in enumerate(dataloader):
            ...
            HR_save = transforms.ToPILImage()(im_hr.cpu()[0])
            HR_save.save('./pictureShow/HR_save.png')
            LR_save = transforms.ToPILImage()(im_lr.cpu()[0])
            LR_save.save('./pictureShow/LR_save.png')
            my_model.zero_grad()
